...
/******************************************************************************
 * An <CODE>ArrayStack<E></CODE> is a generic stack of references to
 * <code>E</code> objects.
 *
 * <dl>
 * <dt><b>Limitations:</b>
 ...
 * The constructor, <CODE>ensureCapacity</CODE>, <CODE>push</CODE>, and
 * <CODE>trimToSize</CODE> will result in an <CODE>OutOfMemoryError</CODE> when
...
public class ArrayStack<E> implements Cloneable {
	/*
	 * Invariant of the ArrayStack class: 1. The number of items in the stack is
	 * in the instance variable manyItems. 2. For an empty stack, we do not care
	 * what is stored in any of data; for a non-empty stack, the items in the
	 * stack are stored in a partially-filled array called data, with the bottom
	 * of the stack at data[0], the next item at data[1], and so on to the top
	 ...
	 *                Indicates insufficient memory for: <CODE>new Object[10]
	 *                </CODE>.
	 **/
	public ArrayStack() {
	 ...
	 * 
	 * @param <CODE>initialCapacity</CODE> the initial capacity of this stack
	 *        <dt><b>Precondition:</b>
	 *        <dd>
	 ...
	 * @exception OutOfMemoryError
	 *                Indicates insufficient memory for: <CODE>new
	 *                Object[initialCapacity]</CODE>.
	 **/
	public ArrayStack(int initialCapacity) {
		if (initialCapacity < 0)
			throw new IllegalArgumentException("initialCapacity too small "
					+ initialCapacity);
		manyItems = 0;
	...
	public ArrayStack<E> clone() { // Clone an ArrayStack.
		...
		try {
			 ...
			 * probably indicate a // programming error that made super.clone
			 * unavailable. The most // comon error // The most common error
			 * would be forgetting the // "Implements Cloneable" // clause at
	 ...
	 * 
	 * @param <CODE>minimumCapacity</CODE> the new capacity for this stack <dt>
	 *        <b>Postcondition:</b>
	 *        <dd>
	 ...
	 *                the stack to fail with an arithmetic overflow.
	 **/
